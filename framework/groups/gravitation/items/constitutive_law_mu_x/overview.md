...
Every material has a constitutive law. It is the equation that tells you how the material responds when you push on it. (Einstein, 1915; Hassan and Rosen, 2012; Milgrom, 1983)

Stretch a spring, and Hooke law tells you the restoring force is proportional to the displacement. Push current through a wire, and Ohm law tells you the voltage is proportional to the current. Heat one end of a metal rod, and Fourier law tells you how fast the heat flows to the other end. In each case, the constitutive law is not the force itself. It is the material response to the force. It encodes the internal structure of the medium, the stiffness of the spring, the resistivity of the wire, and the conductivity of the metal. (Einstein, 1915; Hassan and Rosen, 2012; Milgrom, 1983)

The gravitational field is a medium. It carries waves. It has structure. It must have a constitutive law. (Einstein, 1915; Hassan and Rosen, 2012; Milgrom, 1983)
...
where $x = g/a_0$ is the local gravitational acceleration measured in units of the characteristic scale. This single equation governs how the gravitational field responds to mass at every scale in the universe, from the interior of atoms to the edges of galaxy clusters. It is not chosen from a menu of options. It is not fitted to rotation curves. It is derived from the topology of the stellated octahedron, and every number in it traces back to the two integers $K = 4$ and $D = 3$. (Einstein, 1915; Hassan and Rosen, 2012; Milgrom, 1983)

This page explains where it comes from, what it means, and why it is the same equation as the Poisson equation you already know. (Einstein, 1915; Hassan and Rosen, 2012; Milgrom, 1983)

## What the Constitutive Law Does

Point a telescope at a spiral galaxy and measure how fast the stars orbit at different distances from the center. Close to the center, where the gravitational field is strong, everything behaves exactly as Newton predicted. The orbital velocity rises, peaks, and should then decline as you move outward, because the mass is concentrated in the center and gravity weakens with distance. (Einstein, 1915; Hassan and Rosen, 2012; Milgrom, 1983)

It does not decline. The rotation curve stays flat, all the way out to the farthest measurable stars and gas clouds. The velocity at 50,000 light years from the galactic center is roughly the same as the velocity at 15,000 light years. Newton equation, applied honestly, says this is impossible unless there is far more mass present than we can see. (Einstein, 1915; Hassan and Rosen, 2012; Milgrom, 1983)

The standard response is dark matter: an invisible substance, five times more abundant than ordinary matter, arranged in a halo around every galaxy, fine tuned to produce exactly the flat rotation curve we observe. It has never been directly detected. (Einstein, 1915; Hassan and Rosen, 2012; Milgrom, 1983)

The constitutive law offers a different explanation. It says the gravitational field has two chambers, TetA and TetB, coupled at the Field Origin. At high accelerations, TetA does all the work and gravity looks Newtonian. At low accelerations, TetB picks up the slack, contributing additional gravitational effect that keeps rotation curves flat. The constitutive law μ(x) governs the handoff between them. (Einstein, 1915; Hassan and Rosen, 2012; Milgrom, 1983)

When x is much larger than 1, strong field, well above the characteristic scale $a_0$, the constitutive law gives $\mu \approx 1$. All coupling channels are active. Newton inverse square law holds. This is the regime of the solar system, of laboratory experiments, and of everything humans directly experience. (Einstein, 1915; Hassan and Rosen, 2012; Milgrom, 1983)

When x is much smaller than 1, weak field, well below $a_0$, the constitutive law gives $\mu \approx x$. The Newtonian contribution from visible matter accounts for only a fraction of the total gravitational effect. TetB, the dual chamber, provides the rest. This is the regime of the outer edges of galaxies, where rotation curves flatten and the need for dark matter was first inferred. (Einstein, 1915; Hassan and Rosen, 2012; Milgrom, 1983)

At $x = 1$, exactly at $a_0$, the constitutive law gives $\mu(1) = 1/2$. This is the Field Origin, the geometric center of the stellated octahedron where the two chambers meet face to face and contribute equally. Half the gravitational effect comes from TetA, half from TetB. The transition is not gradual or approximate. It is the midpoint of the topology. (Einstein, 1915; Hassan and Rosen, 2012; Milgrom, 1983)

## Where It Comes From: Three Terms of One Polynomial

The Coupling Polynomial page derived f(K, s) = 1 + sK + K^2, the polynomial that counts how deeply the gravitational field couples at each structural level of the stellated octahedron. Evaluated at K = 4, it gives three structural values: f(+1) = 21 in TetA, f(0) = 17 at the Field Origin, and f(-1) = 13 in TetB. (Einstein, 1915; Hassan and Rosen, 2012; Milgrom, 1983)

The constitutive law is what happens when you let this polynomial vary continuously. (Einstein, 1915; Hassan and Rosen, 2012; Milgrom, 1983)

Instead of evaluating f at three fixed states, allow the state parameter s to change smoothly with the local acceleration. The Möbius map (Einstein, 1915; Hassan and Rosen, 2012; Milgrom, 1983)

$$
s(x) = \frac{x - 1}{x + 1}
$$

does exactly this. It maps the acceleration ratio $x \in [0,\infty)$ onto the state parameter $s \in [-1,+1)$, with $s = 0$ at $x = 1$, the Field Origin. This map is not chosen. It is the unique Möbius transformation satisfying three closure constraints: s must equal -1 at zero acceleration (TetB endpoint), +1 at infinite acceleration (TetA endpoint), and 0 at the transition (Field Origin). Three constraints fix three parameters. The map is determined. (Einstein, 1915; Hassan and Rosen, 2012; Milgrom, 1983)
...
This is f(K, s) evaluated continuously across all accelerations. It ranges from 13 (deep field, TetB dominant) to 21 (strong field, TetA dominant), passing through 17 at x = 1. (Einstein, 1915; Hassan and Rosen, 2012; Milgrom, 1983)
...
The sum is always 1. Always 100% of the field. This is not a modification. It is a decomposition. The gravitational field has two chambers, and the constitutive law tells you how much of the total effect each chamber carries at a given acceleration. (Einstein, 1915; Hassan and Rosen, 2012; Milgrom, 1983)
...
$$
\nabla^2 \Phi = K\pi \times \frac{K^2 + 1}{KD + 1} \times G_{\text{bare}} \times \rho = 4\pi \times \left(\frac{17}{13}\right) \times G_{\text{bare}} \times \rho (Einstein, 1915; Hassan and Rosen, 2012; Milgrom, 1983)
$$

Every factor in that equation comes from the coupling polynomial. The 4pi = Kpi is the solid angle partition by K = 4 tetrahedral faces. The 17 = f(K, 0) is the coupling capacity at the Field Origin. The 13 = f(K, -1) is the observable capacity at the spatial projection. The ratio 17/13 is f sampled at two fixed structural states: s = 0 and s = -1. (Einstein, 1915; Hassan and Rosen, 2012; Milgrom, 1983)
...
This equation evaluates f continuously, not at two fixed points, but across all acceleration states through the Möbius map. The constitutive law $\mu = (f - 13)/8$ sweeps the capacity function through its entire range as the acceleration varies from point to point. (Einstein, 1915; Hassan and Rosen, 2012; Milgrom, 1983)

These are not two different equations. They are two projections of the same polynomial. (Einstein, 1915; Hassan and Rosen, 2012; Milgrom, 1983)

The Poisson equation samples the coupling polynomial at two fixed structural states, the Field Origin and the spatial projection, and packages the result as a constant prefactor 4pi(17/13)G_bare. The constitutive law evaluates the same polynomial continuously, letting the state parameter vary with the local acceleration. One is a snapshot. The other is a film. Both are images of f(K, s) = 1 + sK + K^2. (Einstein, 1915; Hassan and Rosen, 2012; Milgrom, 1983)
...
This is the local field equation. It contains all of Newtonian gravity (when $g \gg a_0$, the equation gives $v^4 \approx GM \times g$, which is the standard virial relation) and all of the deep field regime (when $g \ll a_0$, it gives $v^4 \approx GM \times a_0$, which is the baryonic Tully Fisher relation $M \propto v^4$). The constitutive law bridges them with one continuous function. (Einstein, 1915; Hassan and Rosen, 2012; Milgrom, 1983)
